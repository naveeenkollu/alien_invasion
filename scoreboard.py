...
class Scoreboard:
    ...
    def __init__(self, ai_game):
        """Initializing the score keeping attributes"""
    ...
    def prep_high_score(self):
        ...
        self.high_score_rect.top = self.screen_rect.top + 50
    ...
    def prep_ships(self):
        ...
        for ship_number in range(self.stats.ships_left):
            ...
            ship.rect.x = 50 + ship_number * ship.rect.width 
            ship.rect.y = 50
            self.ships.add(ship)
